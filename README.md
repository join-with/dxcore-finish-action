# dxcore-finish-action

Finish a DxCore session and report the dispatcher result.

> This action is synced from the [joinwith monorepo](https://github.com/join-with/joinwith). Do not edit directly.
